...
- ✅ **无需数据库** - 数据存储在 JS 文件中，开箱即用
- ✅ **前后端分离** - React SPA + Express API
- ✅ **易于部署** - 无需配置数据库连接
- ✅ **数据易管理** - 直接修改 JS 文件即可更新数据
- ✅ **可视化丰富** - ECharts 图表、思维导图、知识图谱

## 数据管理

所有数据存储在 `backend/src/models/` 目录：

- `researchData.js` - 研究领域、AI应用、方法、标签、思维导图等（约1000行）
- `articlesData.js` - 论文文章数据

修改数据后重启后端服务即可生效，无需数据库迁移。
